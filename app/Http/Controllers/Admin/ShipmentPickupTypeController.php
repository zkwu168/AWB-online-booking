...
class ShipmentPickupTypeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.shipmentPickupTypes.index', compact('shipmentPickupTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.shipmentPickupTypes.create');
    }
    ...
    public function store(StoreShipmentPickupTypeRequest $request)
    {
        ...
        return redirect()->route('admin.shipment-pickup-types.index');
    }
    ...
    public function edit(ShipmentPickupType $shipmentPickupType)
    {
        ...
        return view('admin.shipmentPickupTypes.edit', compact('shipmentPickupType'));
    }
    ...
    public function show(ShipmentPickupType $shipmentPickupType)
    {
        ...
        return view('admin.shipmentPickupTypes.show', compact('shipmentPickupType'));
    }
