...
class ImporterInfoController extends Controller
{
    public function index()
    {
        ...
        return view('admin.importerInfos.index', compact('importerInfos'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.importerInfos.create');
    }
    ...
    public function store(StoreImporterInfoRequest $request)
    {
        ...
        return redirect()->route('admin.importer-infos.index');
    }
    ...
    public function edit(ImporterInfo $importerInfo)
    {
        ...
        return view('admin.importerInfos.edit', compact('importerInfo'));
    }
    ...
    public function show(ImporterInfo $importerInfo)
    {
        ...
        return view('admin.importerInfos.show', compact('importerInfo'));
    }
