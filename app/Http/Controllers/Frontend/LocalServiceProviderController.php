...
class LocalServiceProviderController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.localServiceProviders.index', compact('localServiceProviders'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.localServiceProviders.create');
    }
    ...
    public function store(StoreLocalServiceProviderRequest $request)
    {
        ...
        return redirect()->route('frontend.local-service-providers.index');
    }
    ...
    public function edit(LocalServiceProvider $localServiceProvider)
    {
        ...
        return view('frontend.localServiceProviders.edit', compact('localServiceProvider'));
    }
    ...
    public function show(LocalServiceProvider $localServiceProvider)
    {
        ...
        return view('frontend.localServiceProviders.show', compact('localServiceProvider'));
    }
