    ...
    <div class="page-header" style="margin-top:150px">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h3><i class="fas fa-layer-group mr-2"></i> <span class="font-weight-semibold"> {{ trans('cruds.shipment.title_singular') }} {{ trans('global.list') }}</h3>
            </div>
                                    ...
                                    <table class=" table  datatable datatable-Shipment">
                                        ...
                                        <tbody>
                                            ...
                                            <tr data-entry-id="{{ $shipment->id }}">
                                                ...
                                                <td>
                                                    {!! $shipment->mailno ?? '<h6><span class="badge badge-pill badge-secondary">Unbooked </span></h6>' !!}
