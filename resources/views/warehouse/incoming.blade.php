    ...
    <div class="page-header" style="margin-top:150px">
        <div class="page-header-content header-elements-lg-inline">
            <div class="page-title d-flex">
                <h3><i class="fas fa-truck-moving mr-2"></i> <span class="font-weight-semibold"> Incoming parcels</h3>
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr data-entry-id="{{ $shipment->id }}">
                                                ...
                                                <?php
                                                    $start    = '2021-12-02';
                                                    $end      = date("Y-m-d");
                                                    $holidays = ['2021-12-27','2021-12-28'];
                                                    $days = get_total_days($start, $end, $holidays);
                                                   if($days > 2)
                                                   {
                                                        echo '<i class="text-danger fas fa-exclamation-triangle"></i><span class="badge badge-info">'.$days.'</span>';
                                                   } // // Result: 3
                                                ?>
