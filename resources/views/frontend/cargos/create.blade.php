                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.cargos.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="count" id="count" value="{{ old('count', '') }}" step="1" required>
                            @if($errors->has('count'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('count') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="unit" id="unit" value="{{ old('unit', 'pcs') }}" required>
                            @if($errors->has('unit'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('unit') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', '') }}" step="0.0001" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="weight" id="weight" value="{{ old('weight', '') }}" step="0.0001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_value" id="total_value" value="{{ old('total_value', '') }}" step="0.0001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="source_area" id="source_area" value="{{ old('source_area', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="product_record_no" id="product_record_no" value="{{ old('product_record_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="statebarcode" id="statebarcode" value="{{ old('statebarcode', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="specifications" id="specifications" value="{{ old('specifications', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="goods_code" id="goods_code" value="{{ old('goods_code', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="good_prepard_no" id="good_prepard_no" value="{{ old('good_prepard_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hs_code" id="hs_code" value="{{ old('hs_code', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hts_code" id="hts_code" value="{{ old('hts_code', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hts_desc" id="hts_desc" value="{{ old('hts_desc', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="item_no" id="item_no" value="{{ old('item_no', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_1" id="qty_1" value="{{ old('qty_1', '') }}" step="0.00001">
                            @if($errors->has('qty_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="unit_1" id="unit_1" value="{{ old('unit_1', '') }}">
