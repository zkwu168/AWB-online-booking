                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.payments.update", [$payment->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', $payment->amount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment_details" id="payment_details" value="{{ old('payment_details', $payment->payment_details) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="payment_date" id="payment_date" value="{{ old('payment_date', $payment->payment_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="refund_amount" id="refund_amount" value="{{ old('refund_amount', $payment->refund_amount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="refund_note" id="refund_note" value="{{ old('refund_note', $payment->refund_note) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pay_by_url" id="pay_by_url" value="{{ old('pay_by_url', $payment->pay_by_url) }}">
