    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.importer-infos.update", [$importerInfo->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="vat">{{ trans('cruds.importerInfo.fields.vat') }}</label>
                            <input class="form-control" type="text" name="vat" id="vat" value="{{ old('vat', $importerInfo->vat) }}">
                            @if($errors->has('vat'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="eori" id="eori" value="{{ old('eori', $importerInfo->eori) }}">
                            @if($errors->has('eori'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('eori') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="importer_company_name" id="importer_company_name" value="{{ old('importer_company_name', $importerInfo->importer_company_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="importer_tel_no" id="importer_tel_no" value="{{ old('importer_tel_no', $importerInfo->importer_tel_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="importer_address" id="importer_address" value="{{ old('importer_address', $importerInfo->importer_address) }}">
