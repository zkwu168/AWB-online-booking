  ...
  <header id="page-topbar">
    ...
    <div class="navbar navbar-expand-lg navbar-dark navbar-static navbar-header">
      ...
      <div class="navbar-brand ">
        <img alt="SF International" data-sticky-width="140" data-sticky-height="67" src="../../../../img/sf-logo-defauld-white.svg">
      </div>
      ...
      <ul class="navbar-nav flex-row order-1 order-lg-2 flex-1 flex-lg-0 justify-content-end align-items-center">
        <li class="nav-item nav-item-dropdown-lg dropdown">
          <a href="#" class="navbar-nav-link navbar-nav-link-toggler dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="d-none d-lg-inline-block ml-2">{{ strtoupper(app()->getLocale()) }}</span>
          </a>
        ...
        <div class="navbar-collapse collapse" id="navbar-demo-dark">
          <ul class="navbar-nav">
            ...
            <li class="nav-item float-right">
              <a href="/warehouse/incoming" class="navbar-nav-link"><i class="fas fa-truck-moving mr-1"></i></i>Incoming parcels</a>
            </li>

            <li class="nav-item float-right">
              <a href="/warehouse/inventory" class="navbar-nav-link"><i class="fas fa-boxes mr-1"></i>Inventory of parcels</a>
            </li>

            <li class="nav-item float-right">
              <a href="/warehouse/inbound-scan" class="navbar-nav-link"><i class="fas fa-barcode mr-1"></i>  Inbound Scan</a>
            </li>

            <li class="nav-item float-right">
              <a href="/warehouse/weighing" class="navbar-nav-link"><i class="fas fa-weight mr-1"></i>  Weighing</a>
            </li>

            <li class="nav-item float-right">
              <a href="/warehouse/despatch" class="navbar-nav-link"><i class="fas fa-file-alt mr-1"></i>  Despatch</a>
            </li>
          </ul>
  ...
  <div class="navbar navbar-expand-lg navbar-light border-bottom-0 border-top footer">
    ...
    <div class="navbar-collapse collapse float-right" id="navbar-footer">
      <span class="float-right m-2">
        <p><strong>SF Express (Europe) Co. Ltd</strong> - © Copyright 2021. All Rights Reserved.</p>
      </span>
    </div>
  </div>
