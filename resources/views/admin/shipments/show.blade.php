...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#shipment_cargos" role="tab" data-toggle="tab">
                {{ trans('cruds.cargo.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="shipment_cargos">
            @includeIf('admin.shipments.relationships.shipmentCargos', ['cargos' => $shipment->shipmentCargos])
        </div>
    </div>
</div>
