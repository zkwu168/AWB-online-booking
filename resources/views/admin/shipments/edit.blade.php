    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.shipments.update", [$shipment->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference_no_1') ? 'is-invalid' : '' }}" type="text" name="reference_no_1" id="reference_no_1" value="{{ old('reference_no_1', $shipment->reference_no_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mailno') ? 'is-invalid' : '' }}" type="text" name="mailno" id="mailno" value="{{ old('mailno', $shipment->mailno) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_gen_bill_no') ? 'is-invalid' : '' }}" type="number" name="is_gen_bill_no" id="is_gen_bill_no" value="{{ old('is_gen_bill_no', $shipment->is_gen_bill_no) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('j_email') ? 'is-invalid' : '' }}" type="text" name="j_email" id="j_email" value="{{ old('j_email', $shipment->j_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('j_company') ? 'is-invalid' : '' }}" type="text" name="j_company" id="j_company" value="{{ old('j_company', $shipment->j_company) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('j_contact') ? 'is-invalid' : '' }}" type="text" name="j_contact" id="j_contact" value="{{ old('j_contact', $shipment->j_contact) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('j_tel') ? 'is-invalid' : '' }}" type="text" name="j_tel" id="j_tel" value="{{ old('j_tel', $shipment->j_tel) }}">
                @if($errors->has('j_tel'))
                    <div class="invalid-feedback">
                        {{ $errors->first('j_tel') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('j_mobile') ? 'is-invalid' : '' }}" type="text" name="j_mobile" id="j_mobile" value="{{ old('j_mobile', $shipment->j_mobile) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('j_area_code') ? 'is-invalid' : '' }}" type="text" name="j_area_code" id="j_area_code" value="{{ old('j_area_code', $shipment->j_area_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('j_country') ? 'is-invalid' : '' }}" type="text" name="j_country" id="j_country" value="{{ old('j_country', $shipment->j_country) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('j_province') ? 'is-invalid' : '' }}" type="text" name="j_province" id="j_province" value="{{ old('j_province', $shipment->j_province) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('j_city') ? 'is-invalid' : '' }}" type="text" name="j_city" id="j_city" value="{{ old('j_city', $shipment->j_city) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('j_county') ? 'is-invalid' : '' }}" type="text" name="j_county" id="j_county" value="{{ old('j_county', $shipment->j_county) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('j_address') ? 'is-invalid' : '' }}" type="text" name="j_address" id="j_address" value="{{ old('j_address', $shipment->j_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('j_post_code') ? 'is-invalid' : '' }}" type="text" name="j_post_code" id="j_post_code" value="{{ old('j_post_code', $shipment->j_post_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_custid') ? 'is-invalid' : '' }}" type="text" name="d_custid" id="d_custid" value="{{ old('d_custid', $shipment->d_custid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_email') ? 'is-invalid' : '' }}" type="text" name="d_email" id="d_email" value="{{ old('d_email', $shipment->d_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_company') ? 'is-invalid' : '' }}" type="text" name="d_company" id="d_company" value="{{ old('d_company', $shipment->d_company) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_contact') ? 'is-invalid' : '' }}" type="text" name="d_contact" id="d_contact" value="{{ old('d_contact', $shipment->d_contact) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_contact_cn') ? 'is-invalid' : '' }}" type="text" name="d_contact_cn" id="d_contact_cn" value="{{ old('d_contact_cn', $shipment->d_contact_cn) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_tel') ? 'is-invalid' : '' }}" type="text" name="d_tel" id="d_tel" value="{{ old('d_tel', $shipment->d_tel) }}" required>
                @if($errors->has('d_tel'))
                    <div class="invalid-feedback">
                        {{ $errors->first('d_tel') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_mobile') ? 'is-invalid' : '' }}" type="text" name="d_mobile" id="d_mobile" value="{{ old('d_mobile', $shipment->d_mobile) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_area_code') ? 'is-invalid' : '' }}" type="text" name="d_area_code" id="d_area_code" value="{{ old('d_area_code', $shipment->d_area_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_country') ? 'is-invalid' : '' }}" type="text" name="d_country" id="d_country" value="{{ old('d_country', $shipment->d_country) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_province') ? 'is-invalid' : '' }}" type="text" name="d_province" id="d_province" value="{{ old('d_province', $shipment->d_province) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_city') ? 'is-invalid' : '' }}" type="text" name="d_city" id="d_city" value="{{ old('d_city', $shipment->d_city) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_county') ? 'is-invalid' : '' }}" type="text" name="d_county" id="d_county" value="{{ old('d_county', $shipment->d_county) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_address') ? 'is-invalid' : '' }}" type="text" name="d_address" id="d_address" value="{{ old('d_address', $shipment->d_address) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('d_post_code') ? 'is-invalid' : '' }}" type="text" name="d_post_code" id="d_post_code" value="{{ old('d_post_code', $shipment->d_post_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ddp_remark') ? 'is-invalid' : '' }}" type="text" name="ddp_remark" id="ddp_remark" value="{{ old('ddp_remark', $shipment->ddp_remark) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cargo_length') ? 'is-invalid' : '' }}" type="number" name="cargo_length" id="cargo_length" value="{{ old('cargo_length', $shipment->cargo_length) }}" step="0.001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cargo_width') ? 'is-invalid' : '' }}" type="number" name="cargo_width" id="cargo_width" value="{{ old('cargo_width', $shipment->cargo_width) }}" step="0.001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cargo_height') ? 'is-invalid' : '' }}" type="number" name="cargo_height" id="cargo_height" value="{{ old('cargo_height', $shipment->cargo_height) }}" step="0.001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cargo_total_weight') ? 'is-invalid' : '' }}" type="number" name="cargo_total_weight" id="cargo_total_weight" value="{{ old('cargo_total_weight', $shipment->cargo_total_weight) }}" step="0.001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('express_type') ? 'is-invalid' : '' }}" type="number" name="express_type" id="express_type" value="{{ old('express_type', $shipment->express_type) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parcel_quantity') ? 'is-invalid' : '' }}" type="number" name="parcel_quantity" id="parcel_quantity" value="{{ old('parcel_quantity', $shipment->parcel_quantity) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('oneself_pickup_flg') ? 'is-invalid' : '' }}" type="number" name="oneself_pickup_flg" id="oneself_pickup_flg" value="{{ old('oneself_pickup_flg', $shipment->oneself_pickup_flg) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pay_method') ? 'is-invalid' : '' }}" type="number" name="pay_method" id="pay_method" value="{{ old('pay_method', $shipment->pay_method) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('custid') ? 'is-invalid' : '' }}" type="text" name="custid" id="custid" value="{{ old('custid', $shipment->custid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thd_3_pay_area') ? 'is-invalid' : '' }}" type="text" name="thd_3_pay_area" id="thd_3_pay_area" value="{{ old('thd_3_pay_area', $shipment->thd_3_pay_area) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('trade_condition') ? 'is-invalid' : '' }}" type="text" name="trade_condition" id="trade_condition" value="{{ old('trade_condition', $shipment->trade_condition) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('express_reason') ? 'is-invalid' : '' }}" type="number" name="express_reason" id="express_reason" value="{{ old('express_reason', $shipment->express_reason) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('express_reason_content') ? 'is-invalid' : '' }}" type="text" name="express_reason_content" id="express_reason_content" value="{{ old('express_reason_content', $shipment->express_reason_content) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('buss_remark') ? 'is-invalid' : '' }}" type="text" name="buss_remark" id="buss_remark" value="{{ old('buss_remark', $shipment->buss_remark) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('custom_batch') ? 'is-invalid' : '' }}" type="text" name="custom_batch" id="custom_batch" value="{{ old('custom_batch', $shipment->custom_batch) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('harmonized_code') ? 'is-invalid' : '' }}" type="text" name="harmonized_code" id="harmonized_code" value="{{ old('harmonized_code', $shipment->harmonized_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aes_no') ? 'is-invalid' : '' }}" type="text" name="aes_no" id="aes_no" value="{{ old('aes_no', $shipment->aes_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('receiver_type') ? 'is-invalid' : '' }}" type="text" name="receiver_type" id="receiver_type" value="{{ old('receiver_type', $shipment->receiver_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_cert_no') ? 'is-invalid' : '' }}" type="text" name="order_cert_no" id="order_cert_no" value="{{ old('order_cert_no', $shipment->order_cert_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('realweightqty') ? 'is-invalid' : '' }}" type="number" name="realweightqty" id="realweightqty" value="{{ old('realweightqty', $shipment->realweightqty) }}" step="0.0001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('volumeweightqty') ? 'is-invalid' : '' }}" type="number" name="volumeweightqty" id="volumeweightqty" value="{{ old('volumeweightqty', $shipment->volumeweightqty) }}" step="0.0001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meterageweightqty') ? 'is-invalid' : '' }}" type="number" name="meterageweightqty" id="meterageweightqty" value="{{ old('meterageweightqty', $shipment->meterageweightqty) }}" step="0.0001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('currency') ? 'is-invalid' : '' }}" type="text" name="currency" id="currency" value="{{ old('currency', $shipment->currency) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_baggage') ? 'is-invalid' : '' }}" type="text" name="is_baggage" id="is_baggage" value="{{ old('is_baggage', $shipment->is_baggage) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sender_type') ? 'is-invalid' : '' }}" type="text" name="sender_type" id="sender_type" value="{{ old('sender_type', $shipment->sender_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('export_customer_type') ? 'is-invalid' : '' }}" type="text" name="export_customer_type" id="export_customer_type" value="{{ old('export_customer_type', $shipment->export_customer_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_under_call') ? 'is-invalid' : '' }}" type="text" name="is_under_call" id="is_under_call" value="{{ old('is_under_call', $shipment->is_under_call) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('import_customer_type') ? 'is-invalid' : '' }}" type="text" name="import_customer_type" id="import_customer_type" value="{{ old('import_customer_type', $shipment->import_customer_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('estimated_freight') ? 'is-invalid' : '' }}" type="number" name="estimated_freight" id="estimated_freight" value="{{ old('estimated_freight', $shipment->estimated_freight) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('actual_freight') ? 'is-invalid' : '' }}" type="number" name="actual_freight" id="actual_freight" value="{{ old('actual_freight', $shipment->actual_freight) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paid_freight') ? 'is-invalid' : '' }}" type="number" name="paid_freight" id="paid_freight" value="{{ old('paid_freight', $shipment->paid_freight) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('outstanding_fee') ? 'is-invalid' : '' }}" type="number" name="outstanding_fee" id="outstanding_fee" value="{{ old('outstanding_fee', $shipment->outstanding_fee) }}" step="0.01">
