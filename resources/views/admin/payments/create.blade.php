    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('payment_date') ? 'is-invalid' : '' }}" type="text" name="payment_date" id="payment_date" value="{{ old('payment_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('refund_note') ? 'is-invalid' : '' }}" type="text" name="refund_note" id="refund_note" value="{{ old('refund_note', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pay_by_url') ? 'is-invalid' : '' }}" type="text" name="pay_by_url" id="pay_by_url" value="{{ old('pay_by_url', '') }}">
