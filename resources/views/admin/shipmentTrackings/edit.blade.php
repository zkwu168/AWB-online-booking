...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.shipment-trackings.update", [$shipmentTracking->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="sf_awb_url">{{ trans('cruds.shipmentTracking.fields.sf_awb_url') }}</label>
                <input class="form-control {{ $errors->has('sf_awb_url') ? 'is-invalid' : '' }}" type="text" name="sf_awb_url" id="sf_awb_url" value="{{ old('sf_awb_url', $shipmentTracking->sf_awb_url) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('international_route') ? 'is-invalid' : '' }}" name="international_route" id="international_route">{{ old('international_route', $shipmentTracking->international_route) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('local_route') ? 'is-invalid' : '' }}" name="local_route" id="local_route">{{ old('local_route', $shipmentTracking->local_route) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('api_request') ? 'is-invalid' : '' }}" name="api_request" id="api_request">{{ old('api_request', $shipmentTracking->api_request) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('api_response') ? 'is-invalid' : '' }}" name="api_response" id="api_response">{{ old('api_response', $shipmentTracking->api_response) }}</textarea>
