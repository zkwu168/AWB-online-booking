    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.cargos.update", [$cargo->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $cargo->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('count') ? 'is-invalid' : '' }}" type="number" name="count" id="count" value="{{ old('count', $cargo->count) }}" step="1" required>
                @if($errors->has('count'))
                    <div class="invalid-feedback">
                        {{ $errors->first('count') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit') ? 'is-invalid' : '' }}" type="text" name="unit" id="unit" value="{{ old('unit', $cargo->unit) }}" required>
                @if($errors->has('unit'))
                    <div class="invalid-feedback">
                        {{ $errors->first('unit') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="number" name="amount" id="amount" value="{{ old('amount', $cargo->amount) }}" step="0.0001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="number" name="weight" id="weight" value="{{ old('weight', $cargo->weight) }}" step="0.0001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_value') ? 'is-invalid' : '' }}" type="number" name="total_value" id="total_value" value="{{ old('total_value', $cargo->total_value) }}" step="0.0001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('currency') ? 'is-invalid' : '' }}" type="text" name="currency" id="currency" value="{{ old('currency', $cargo->currency) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('source_area') ? 'is-invalid' : '' }}" type="text" name="source_area" id="source_area" value="{{ old('source_area', $cargo->source_area) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_record_no') ? 'is-invalid' : '' }}" type="text" name="product_record_no" id="product_record_no" value="{{ old('product_record_no', $cargo->product_record_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('brand') ? 'is-invalid' : '' }}" type="text" name="brand" id="brand" value="{{ old('brand', $cargo->brand) }}">
                @if($errors->has('brand'))
                    <div class="invalid-feedback">
                        {{ $errors->first('brand') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statebarcode') ? 'is-invalid' : '' }}" type="text" name="statebarcode" id="statebarcode" value="{{ old('statebarcode', $cargo->statebarcode) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('specifications') ? 'is-invalid' : '' }}" type="text" name="specifications" id="specifications" value="{{ old('specifications', $cargo->specifications) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('goods_code') ? 'is-invalid' : '' }}" type="text" name="goods_code" id="goods_code" value="{{ old('goods_code', $cargo->goods_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('good_prepard_no') ? 'is-invalid' : '' }}" type="text" name="good_prepard_no" id="good_prepard_no" value="{{ old('good_prepard_no', $cargo->good_prepard_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hts_code') ? 'is-invalid' : '' }}" type="text" name="hts_code" id="hts_code" value="{{ old('hts_code', $cargo->hts_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hts_desc') ? 'is-invalid' : '' }}" type="text" name="hts_desc" id="hts_desc" value="{{ old('hts_desc', $cargo->hts_desc) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('item_no') ? 'is-invalid' : '' }}" type="number" name="item_no" id="item_no" value="{{ old('item_no', $cargo->item_no) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qty_1') ? 'is-invalid' : '' }}" type="number" name="qty_1" id="qty_1" value="{{ old('qty_1', $cargo->qty_1) }}" step="0.00001">
                @if($errors->has('qty_1'))
                    <div class="invalid-feedback">
                        {{ $errors->first('qty_1') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_1') ? 'is-invalid' : '' }}" type="text" name="unit_1" id="unit_1" value="{{ old('unit_1', $cargo->unit_1) }}">
